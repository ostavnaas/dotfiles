...
runcmd:
  ...
  - curl https://raw.githubusercontent.com/ostavnaas/dotfiles/master/scripts/k8s/libs/pre-k8s.sh | bash
  - echo "192.168.122.21 k8s.no.wognild.no" | tee -a /etc/hosts
